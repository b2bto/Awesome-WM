...
menubar.menu_gen.all_menu_dirs = { "/usr/share/applications/", "/usr/local/share/applications", "/home/liun1x/.local/share/applications" }

-- Configuración de la barra de menú
menubar.utils.terminal = "kitty" -- Configurar el terminal para aplicaciones que lo requieran
...
--------------------------------------------- Atajos Creados por mi
     -- Firefox
    awful.key({modkey}, "f", function()
        awful.spawn.with_shell(browser)
    end,
    {description = "Abrira navegador Firefox-Mosilla", group = "launcher"}),
     -- Google
     awful.key({modkey}, "g", function()
        awful.spawn.with_shell(browserG)
    end,
    {description = "Abrira navegador Google", group = "launcher"}),
     -- Editor VisualStudioCode
     awful.key({modkey}, "v", function()
        awful.spawn.with_shell(vscode)
    end,
    {description = "Abrira el editor de codigo Visua Studio Code", group = "launcher"}),

     -- Inkscape
     awful.key({modkey}, "i", function()
        awful.spawn.with_shell(ink)
    end,
    {description = "Abrira editor de imagenes vectoriales Inkscape", group = "launcher"}),
    -- Gimp
    awful.key({modkey_alt, modkey_shift}, "g", function()
    awful.spawn.with_shell(gimp)
    end,
    {description = "Abrira editor de imagenes Gimp", group = "launcher"}),
    -- Gestor de archivos
    awful.key({modkey}, "t", function()
        awful.spawn.with_shell(archivos)
        end,
        {description = "Abrira gestor de archivos", group = "launcher"}),
